...
#cd /c/projects/nss/tests/; BUILD_OPT=1 USE_64=1 HOST=localhost DOMSUF=localdomain NSS_ENABLE_TLS_1_3=1 NSS_TESTS="ssl_gtests gtests" NSS_CYCLES=standard ./all.sh
exit
